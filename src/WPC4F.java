...
public class WPC4F {
    ...
    public static int minOfThreeInteger(int a, int b, int c) {
    ...
    public static void main(String[] args) {
        ...
        while (testCases-- > 0) {
            ...
            System.out.println(minOfThreeInteger(turtles[noOfTurtles - 1][0], turtles[noOfTurtles - 1][1], turtles[noOfTurtles - 1][2]));
        }
    }
